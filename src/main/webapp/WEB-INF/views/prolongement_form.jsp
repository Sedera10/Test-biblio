            ...
            <div class="glass-form">
                ...
                <form method="post" action="${pageContext.request.contextPath}/prolongement/valider">
                    <div class="mb-3">
                        ...
                        <p class="form-control-plaintext">${pret.exemplaire.livre.titre}</p>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Exemplaire ID :</label>
                        <p class="form-control-plaintext">${pret.exemplaire.id}</p>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold">Date retour actuelle :</label>
                        <p class="form-control-plaintext">${pret.dateRetour}</p>
                    </div>

                    <div class="mb-3">
                        <label for="nouvelleDate" class="form-label fw-bold">Nouvelle date de retour :</label>
                        <input type="date" id="nouvelleDate" name="nouvelleDate" class="form-control" required>
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-arrow-repeat"></i> Valider le prolongement
                        </button>
                    </div>
                </form>
            </div>
