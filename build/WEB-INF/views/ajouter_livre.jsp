...
<html>
<head>
    <title>Ajouter un Livre | BIBLIO-TECHNO</title>
    <meta charset="utf-8">
    ...
    <div class="main">
        ...
        <main class="content">
            <div class="glass-form">
                <h3 class="mb-4">Ajouter un Nouveau Livre</h3>
                ...
                <form action="${pageContext.request.contextPath}/livres/ajouter" method="post">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Limite d'âge (optionnel) :</label>
                        <input type="number" name="limiteAge" class="form-control" min="0" />
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Autoriser prêt à domicile :</label><br/>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-plus-circle"></i> Ajouter le livre
                        </button>
                    </div>
                </form>
            </div>
